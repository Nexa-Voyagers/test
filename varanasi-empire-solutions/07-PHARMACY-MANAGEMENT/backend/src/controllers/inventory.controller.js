...
export const getAll = asyncHandler(async (req, res) => {
  const result = await '${controller}'Service.getAll(req.user.pharmacyId, req.query);
...
export const create = asyncHandler(async (req, res) => {
  const result = await '${controller}'Service.create({ ...req.body, pharmacyId: req.user.pharmacyId, createdBy: req.user.id });
