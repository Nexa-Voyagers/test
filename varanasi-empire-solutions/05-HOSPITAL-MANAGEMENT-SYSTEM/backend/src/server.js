...
apiRouter.use('/lab', authMiddleware, labRoutes);
apiRouter.use('/ipd', authMiddleware, ipdRoutes);
apiRouter.use('/pharmacy', authMiddleware, pharmacyRoutes);
...
app.get('/', (req, res) => {
  res.json({
    success: true,
    message: 'Hospital Information System (HIS) API',
    version: API_VERSION,
...
const startServer = async () => {
  try {
    ...
    app.listen(PORT, () => {
      logger.info(`🚀 Hospital Management Server running in ${process.env.NODE_ENV} mode on port ${PORT}`);
